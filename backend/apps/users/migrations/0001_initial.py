    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('SME', 'Small & Medium Enterprise'), ('CA', 'Chartered Accountant')], default='SME', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('access_level', models.CharField(default='FULL', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('ca', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clients', to=settings.AUTH_USER_MODEL)),
                ('sme', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='chartered_accountants', to=settings.AUTH_USER_MODEL)),
            ],
            options={
